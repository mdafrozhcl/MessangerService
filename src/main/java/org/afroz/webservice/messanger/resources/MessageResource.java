...
/*		if (messageFilterBean.getStart()>= 0 && messageFilterBean.getSize() >= 0) {
			return messageService.getAllPaginatedMessages(messageFilterBean.getStart(), messageFilterBean.getSize());
		}*/
...
/*		if (messageFilterBean.getStart()>= 0 && messageFilterBean.getSize() >= 0) {
	...
	public List<Message> getMessage(@QueryParam("year") int year,
		...
		if (start >= 0 && size >= 0) {
			return messageService.getAllPaginatedMessages(start, size);
		}
		return messageService.getAllMessages();
	}*/
